...
# from app.models.versioning import VersionedMixin  # Removed - using clean versioning
...
#     
#     # Relationships - Temporarily disabled until all models are configured
...
class ScopingDecisionVersion(CustomPKModel, AuditMixin, VersionedMixin):
    ...
    # Relationships - Temporarily disabled until all models are configured
    # cycle = relationship("TestCycle", back_populates="scoping_decision_versions")
    # report = relationship("Report", back_populates="scoping_decision_versions")
