...
class ProfilingRule(CustomPKModel):
    """Profiling rules within version"""
    __tablename__ = 'versioned_profiling_rules'
...
class DataOwnerAssignment(CustomPKModel):
    ...
    __tablename__ = 'versioned_data_owner_assignments'
    ...
    # Change tracking
    previous_assignment_id = Column(UUID, ForeignKey('versioned_data_owner_assignments.assignment_id'))
...
class DocumentSubmission(CustomPKModel):
    ...
    __tablename__ = 'versioned_document_submissions'
    ...
    replaces_submission_id = Column(UUID, ForeignKey('versioned_document_submissions.submission_id'))
