#!/usr/bin/env python3
"""Create a minimal fix for the auth endpoint"""

# Create a simple patch file
patch_content = '''--- a/app/api/v1/endpoints/auth.py
...
with open('auth_endpoint.patch', 'w') as f:
    f.write(patch_content)

print("Patch file created: auth_endpoint.patch")
print("\nTo apply the patch:")
print("patch -p1 < auth_endpoint.patch")