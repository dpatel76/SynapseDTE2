"""
Add Preparing Test Report phase to existing reports
"""
...
async def add_test_report_phase():
    """Add Preparing Test Report phase to existing reports that don't have it"""
    ...
    async with AsyncSessionLocal() as session:
        try:
            ...
            print(f"Found {len(report_combinations)} reports to check")
...
if __name__ == "__main__":
    asyncio.run(add_test_report_phase())