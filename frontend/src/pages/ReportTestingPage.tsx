...
const phaseRouteMapping: Record<string, string> = {
  ...
  'Data Owner Identification': 'data-owner',  // Handle full name
  'Request Info': 'request-info',
  'Request for Information': 'request-info',  // Handle full name
...
const phaseDisplayNames: Record<string, string> = {
  ...
  'Data Owner Identification': 'Data Owner Identification',  // Handle full name
  'Request Info': 'Request for Information',
  'Request for Information': 'Request for Information',  // Handle full name
  'Testing': 'Test Execution',
  'Test Execution': 'Test Execution',  // Correct phase name
  'Observations': 'Observation Management',
...
const ReportTestingPageRedesigned: React.FC = () => {
  ...
  const phaseOrder = [
    ...
    'Sample Selection',
    'Data Provider ID',
    'Data Owner ID', // Handle both variants
    'Data Owner Identification', // Handle full name variant
    'Request Info',
    'Request for Information', // Handle full name variant
    'Test Execution',
  ...
  return (
    <Container maxWidth={false} sx={{ py: 3 }}>
      ...
      <Breadcrumbs separator="›" sx={{ mb: 2 }}>
        ...
        {reportDetail && reportDetail.cycle_name ? (
          <Link
            color="inherit"
            href="#"
            onClick={(e: React.MouseEvent) => {
      ...
      <Grid container spacing={1.5}>
        {phaseCards.map((phase, index) => {
          ...
          return (
          <Grid key={phase.phase_name} size={{ xs: 12, sm: 6, md: 4 }}>
            <Card
              sx={{
