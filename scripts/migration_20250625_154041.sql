...
-- Generated: 2025-06-25T15:40:41.982830
...
CREATE TABLE cycle_report_scoping_attribute_recommendation_versions (
    ...
    llm_confidence_score double precision(53),
    llm_reasoning text,
    ...
    estimated_effort_hours double precision(53),
    created_at timestamp with time zone NOT NULL DEFAULT now(),
    updated_at timestamp with time zone NOT NULL DEFAULT now(),
...
CREATE TABLE cycle_report_scoping_attribute_recommendations (
    ...
    report_id integer NOT NULL,
    attribute_id integer NOT NULL,
    recommendation_score double precision(53) NOT NULL,
...
CREATE TABLE attribute_version_comparisons (
    ...
    impact_score double precision(53),
...
CREATE TABLE data_owner_sla_violations (
    ...
    hours_overdue double precision(53) NOT NULL,
    escalation_level escalation_level_enum NOT NULL,
...
CREATE TABLE cycle_report_data_profiling_rule_versions (
    ...
    threshold_value double precision(53),
...
CREATE TABLE data_provider_submissions (
    ...
    validation_score double precision(53),
...
CREATE TABLE cycle_report_test_execution_document_analyses (
    ...
    expected_value character varying(500),
    confidence_threshold double precision(53) NOT NULL,
    extracted_value text,
    confidence_score double precision(53) NOT NULL,
...
CREATE TABLE metrics_execution (
    ...
    duration_minutes double precision(53),
    status character varying(50) NOT NULL,
...
CREATE TABLE historical_data_owner_assignments (
    ...
    completion_time_hours double precision(53),
    success_rating double precision(53),
    notes text,
    created_at timestamp with time zone NOT NULL DEFAULT now(),
    updated_at timestamp with time zone NOT NULL DEFAULT now(),
...
CREATE TABLE cycle_report_observation_mgmt_impact_assessments (
    ...
    impact_score double precision(53) NOT NULL,
    financial_impact_min double precision(53),
    financial_impact_max double precision(53),
    financial_impact_currency character varying,
    regulatory_requirements_affected json,
    regulatory_deadlines json,
    potential_penalties double precision(53),
    ...
    assessment_confidence double precision(53),
...
CREATE TABLE observation_management_phases (
    ...
    approval_threshold double precision(53),
    instructions text,
    notes text,
    started_by integer,
    completed_by integer,
...
CREATE TABLE cycle_report_observation_mgmt_observation_records (
    ...
    detection_confidence double precision(53),
    impact_description text,
    impact_categories json,
    financial_impact_estimate double precision(53),
    ...
    auto_detection_score double precision(53),
...
CREATE TABLE cycle_report_observation_mgmt_resolutions (
    ...
    progress_percentage double precision(53),
    ...
    budget_allocated double precision(53),
    budget_spent double precision(53),
...
CREATE TABLE metrics_phases (
    ...
    total_observations integer,
    approved_observations integer,
    completion_time_minutes double precision(53),
...
CREATE TABLE cycle_report_data_profiling_results (
    ...
    total_count integer,
    pass_rate double precision(53),
    result_summary json,
    failed_records json,
    result_details text,
    quality_impact double precision(53),
...
CREATE TABLE report_attributes (
    ...
    risk_score double precision(53),
...
CREATE TABLE sample_selection_phases (
    ...
    llm_provider character varying(50),
    llm_model character varying(100),
    llm_confidence_threshold double precision(53),
...
CREATE TABLE sample_sets (
    ...
    quality_score double precision(53),
...
CREATE TABLE sample_upload_history (
    ...
    data_quality_score double precision(53) NOT NULL,
...
CREATE TABLE sample_validation_results (
    ...
    overall_quality_score double precision(53) NOT NULL,
...
CREATE TABLE test_comparisons (
    ...
    consistency_score double precision(53) NOT NULL,
...
CREATE TABLE test_execution_versions (
    ...
    confidence_score double precision(53),
...
CREATE TABLE test_result_reviews (
    ...
    completeness_score double precision(53),
    consistency_score double precision(53),
    overall_score double precision(53),
...
CREATE TABLE workflow_alerts (
    ...
    severity character varying(20) NOT NULL,
    threshold_value double precision(53),
    actual_value double precision(53),
    alert_message text,
...
CREATE TABLE workflow_executions (
    ...
    started_at timestamp with time zone,
    completed_at timestamp with time zone,
    duration_seconds double precision(53),
    input_data json,
    output_data json,
    error_details json,
    created_at timestamp with time zone NOT NULL DEFAULT now(),
...
CREATE TABLE workflow_metrics (
    ...
    avg_duration double precision(53),
    min_duration double precision(53),
    max_duration double precision(53),
    p50_duration double precision(53),
    p90_duration double precision(53),
    p95_duration double precision(53),
    p99_duration double precision(53),
    avg_retry_count double precision(53),
...
-- Create indexes
CREATE UNIQUE INDEX assignment_templates_pkey ON assignment_templates USING btree (template_id);
CREATE INDEX ix_assignment_templates_template_id ON assignment_templates USING btree (template_id);
CREATE UNIQUE INDEX attribute_lob_assignments_pkey ON attribute_lob_assignments USING btree (assignment_id);
CREATE INDEX ix_attribute_lob_assignments_assignment_id ON attribute_lob_assignments USING btree (assignment_id);
CREATE UNIQUE INDEX attribute_profiling_scores_pkey ON attribute_profiling_scores USING btree (score_id);
CREATE INDEX ix_attribute_profiling_scores_score_id ON attribute_profiling_scores USING btree (score_id);
CREATE UNIQUE INDEX attribute_scoping_recommendation_versions_pkey ON attribute_scoping_recommendation_versions USING btree (recommendation_version_id);
CREATE UNIQUE INDEX attribute_scoping_recommendations_pkey ON attribute_scoping_recommendations USING btree (recommendation_id);
...
CREATE UNIQUE INDEX attribute_version_change_logs_pkey ON attribute_version_change_logs USING btree (log_id);
CREATE INDEX ix_attribute_version_change_logs_log_id ON attribute_version_change_logs USING btree (log_id);
CREATE UNIQUE INDEX attribute_version_comparisons_pkey ON attribute_version_comparisons USING btree (comparison_id);
CREATE INDEX ix_attribute_version_comparisons_comparison_id ON attribute_version_comparisons USING btree (comparison_id);
CREATE UNIQUE INDEX audit_log_pkey ON audit_log USING btree (audit_id);
...
CREATE UNIQUE INDEX bulk_test_executions_pkey ON bulk_test_executions USING btree (bulk_execution_id);
CREATE INDEX ix_bulk_test_executions_bulk_execution_id ON bulk_test_executions USING btree (bulk_execution_id);
CREATE UNIQUE INDEX cdo_notifications_pkey ON cdo_notifications USING btree (notification_id);
CREATE INDEX ix_cdo_notifications_notification_id ON cdo_notifications USING btree (notification_id);
CREATE UNIQUE INDEX cycle_reports_pkey ON cycle_reports USING btree (cycle_id, report_id);
CREATE INDEX idx_cycle_reports_workflow_id ON cycle_reports USING btree (workflow_id);
CREATE UNIQUE INDEX data_owner_assignments_pkey ON data_owner_assignments USING btree (assignment_id);
CREATE INDEX ix_data_owner_assignments_assignment_id ON data_owner_assignments USING btree (assignment_id);
CREATE UNIQUE INDEX data_owner_escalation_log_pkey ON data_owner_escalation_log USING btree (email_id);
CREATE INDEX ix_data_owner_escalation_log_email_id ON data_owner_escalation_log USING btree (email_id);
CREATE UNIQUE INDEX data_owner_notifications_pkey ON data_owner_notifications USING btree (notification_id);
CREATE INDEX ix_data_owner_notifications_notification_id ON data_owner_notifications USING btree (notification_id);
CREATE UNIQUE INDEX data_owner_phase_audit_log_pkey ON data_owner_phase_audit_log USING btree (audit_id);
...
CREATE UNIQUE INDEX data_owner_sla_violations_pkey ON data_owner_sla_violations USING btree (violation_id);
CREATE INDEX ix_data_owner_sla_violations_violation_id ON data_owner_sla_violations USING btree (violation_id);
CREATE UNIQUE INDEX data_profiling_files_pkey ON data_profiling_files USING btree (file_id);
CREATE INDEX ix_data_profiling_files_file_id ON data_profiling_files USING btree (file_id);
CREATE UNIQUE INDEX data_profiling_phases_pkey ON data_profiling_phases USING btree (phase_id);
CREATE INDEX ix_data_profiling_phases_phase_id ON data_profiling_phases USING btree (phase_id);
CREATE UNIQUE INDEX data_profiling_rule_versions_pkey ON data_profiling_rule_versions USING btree (rule_version_id);
CREATE UNIQUE INDEX data_provider_assignments_pkey ON data_provider_assignments USING btree (assignment_id);
CREATE INDEX ix_data_provider_assignments_assignment_id ON data_provider_assignments USING btree (assignment_id);
CREATE UNIQUE INDEX data_provider_escalation_log_pkey ON data_provider_escalation_log USING btree (email_id);
CREATE INDEX ix_data_provider_escalation_log_email_id ON data_provider_escalation_log USING btree (email_id);
CREATE UNIQUE INDEX data_provider_notifications_pkey ON data_provider_notifications USING btree (notification_id);
CREATE INDEX ix_data_provider_notifications_notification_id ON data_provider_notifications USING btree (notification_id);
CREATE UNIQUE INDEX data_provider_phase_audit_log_pkey ON data_provider_phase_audit_log USING btree (audit_id);
...
CREATE UNIQUE INDEX data_provider_sla_violations_pkey ON data_provider_sla_violations USING btree (violation_id);
CREATE INDEX ix_data_provider_sla_violations_violation_id ON data_provider_sla_violations USING btree (violation_id);
CREATE UNIQUE INDEX data_provider_submissions_pkey ON data_provider_submissions USING btree (submission_id);
CREATE INDEX ix_data_provider_submissions_submission_id ON data_provider_submissions USING btree (submission_id);
CREATE UNIQUE INDEX data_sources_pkey ON data_sources USING btree (data_source_id);
...
CREATE UNIQUE INDEX database_submissions_pkey ON database_submissions USING btree (db_submission_id);
CREATE INDEX ix_database_submissions_db_submission_id ON database_submissions USING btree (db_submission_id);
CREATE UNIQUE INDEX database_tests_pkey ON database_tests USING btree (test_id);
CREATE INDEX ix_database_tests_test_id ON database_tests USING btree (test_id);
CREATE UNIQUE INDEX document_access_logs_pkey ON document_access_logs USING btree (log_id);
CREATE INDEX ix_document_access_logs_log_id ON document_access_logs USING btree (log_id);
CREATE UNIQUE INDEX document_analyses_pkey ON document_analyses USING btree (analysis_id);
CREATE INDEX ix_document_analyses_analysis_id ON document_analyses USING btree (analysis_id);
CREATE UNIQUE INDEX document_extractions_pkey ON document_extractions USING btree (extraction_id);
...
CREATE UNIQUE INDEX document_revisions_pkey ON document_revisions USING btree (revision_id);
CREATE UNIQUE INDEX document_submissions_pkey ON document_submissions USING btree (submission_id);
...
CREATE UNIQUE INDEX documents_pkey ON documents USING btree (document_id);
...
CREATE UNIQUE INDEX escalation_email_logs_pkey ON escalation_email_logs USING btree (log_id);
CREATE INDEX ix_escalation_email_logs_log_id ON escalation_email_logs USING btree (log_id);
CREATE UNIQUE INDEX metrics_execution_pkey ON metrics_execution USING btree (id);
...
CREATE UNIQUE INDEX historical_data_owner_assignments_pkey ON historical_data_owner_assignments USING btree (history_id);
...
CREATE UNIQUE INDEX historical_data_provider_assignments_pkey ON historical_data_provider_assignments USING btree (history_id);
...
CREATE UNIQUE INDEX individual_samples_pkey ON individual_samples USING btree (id);
...
CREATE UNIQUE INDEX llm_audit_log_pkey ON llm_audit_log USING btree (log_id);
...
CREATE UNIQUE INDEX llm_sample_generations_pkey ON llm_sample_generations USING btree (generation_id);
...
CREATE UNIQUE INDEX lobs_pkey ON lobs USING btree (lob_id);
CREATE UNIQUE INDEX ix_lobs_lob_name ON lobs USING btree (lob_name);
CREATE INDEX ix_lobs_lob_id ON lobs USING btree (lob_id);
CREATE UNIQUE INDEX observation_approvals_pkey ON observation_approvals USING btree (approval_id);
CREATE UNIQUE INDEX observation_clarifications_pkey ON observation_clarifications USING btree (clarification_id);
CREATE UNIQUE INDEX observation_groups_pkey ON observation_groups USING btree (group_id);
CREATE UNIQUE INDEX _observation_group_uc ON observation_groups USING btree (cycle_id, report_id, attribute_id, issue_type);
CREATE UNIQUE INDEX observation_impact_assessments_pkey ON observation_impact_assessments USING btree (assessment_id);
CREATE UNIQUE INDEX observation_management_audit_logs_pkey ON observation_management_audit_logs USING btree (log_id);
CREATE UNIQUE INDEX observation_management_phases_pkey ON observation_management_phases USING btree (phase_id);
CREATE UNIQUE INDEX observation_records_pkey ON observation_records USING btree (observation_id);
CREATE UNIQUE INDEX observation_resolutions_pkey ON observation_resolutions USING btree (resolution_id);
CREATE UNIQUE INDEX observation_versions_pkey ON observation_versions USING btree (observation_version_id);
CREATE UNIQUE INDEX observations_pkey ON observations USING btree (observation_id);
CREATE INDEX ix_observations_observation_id ON observations USING btree (observation_id);
CREATE UNIQUE INDEX permission_audit_log_pkey ON permission_audit_log USING btree (audit_id);
...
CREATE UNIQUE INDEX permissions_pkey ON permissions USING btree (permission_id);
...
CREATE UNIQUE INDEX metrics_phases_pkey ON metrics_phases USING btree (id);
...
CREATE UNIQUE INDEX profiling_results_pkey ON profiling_results USING btree (result_id);
CREATE INDEX ix_profiling_results_result_id ON profiling_results USING btree (result_id);
CREATE UNIQUE INDEX profiling_rules_pkey ON profiling_rules USING btree (rule_id);
...
CREATE UNIQUE INDEX regulatory_data_dictionary_pkey ON regulatory_data_dictionary USING btree (dict_id);
...
CREATE UNIQUE INDEX report_attributes_pkey ON report_attributes USING btree (attribute_id);
...
CREATE UNIQUE INDEX report_owner_assignment_history_pkey ON report_owner_assignment_history USING btree (history_id);
...
CREATE UNIQUE INDEX report_owner_assignments_pkey ON report_owner_assignments USING btree (assignment_id);
...
CREATE UNIQUE INDEX report_owner_executives_pkey ON report_owner_executives USING btree (executive_id, report_owner_id);
CREATE UNIQUE INDEX report_owner_scoping_reviews_pkey ON report_owner_scoping_reviews USING btree (review_id);
...
CREATE UNIQUE INDEX request_info_audit_log_pkey ON request_info_audit_log USING btree (audit_id);
...
CREATE UNIQUE INDEX request_info_audit_logs_pkey ON request_info_audit_logs USING btree (log_id);
CREATE INDEX ix_request_info_audit_logs_log_id ON request_info_audit_logs USING btree (log_id);
CREATE UNIQUE INDEX request_info_phases_pkey ON request_info_phases USING btree (phase_id);
CREATE INDEX ix_request_info_phases_phase_id ON request_info_phases USING btree (phase_id);
CREATE UNIQUE INDEX resource_permissions_pkey ON resource_permissions USING btree (resource_permission_id);
...
CREATE UNIQUE INDEX resources_pkey ON resources USING btree (resource_id);
...
CREATE UNIQUE INDEX role_hierarchy_pkey ON role_hierarchy USING btree (parent_role_id, child_role_id);
CREATE UNIQUE INDEX role_permissions_pkey ON role_permissions USING btree (role_id, permission_id);
CREATE UNIQUE INDEX roles_pkey ON roles USING btree (role_id);
...
CREATE UNIQUE INDEX sample_approval_history_pkey ON sample_approval_history USING btree (approval_id);
...
CREATE UNIQUE INDEX sample_audit_logs_pkey ON sample_audit_logs USING btree (id);
...
CREATE UNIQUE INDEX sample_feedback_pkey ON sample_feedback USING btree (id);
...
CREATE UNIQUE INDEX sample_records_pkey ON sample_records USING btree (record_id);
...
CREATE UNIQUE INDEX sample_selection_audit_log_pkey ON sample_selection_audit_log USING btree (audit_id);
...
CREATE UNIQUE INDEX sample_selection_phases_pkey ON sample_selection_phases USING btree (phase_id, id);
CREATE INDEX ix_sample_selection_phases_id ON sample_selection_phases USING btree (id);
CREATE UNIQUE INDEX sample_sets_pkey ON sample_sets USING btree (set_id);
...
CREATE UNIQUE INDEX sample_submission_items_pkey ON sample_submission_items USING btree (id);
CREATE INDEX ix_sample_submission_items_id ON sample_submission_items USING btree (id);
CREATE UNIQUE INDEX sample_submissions_pkey ON sample_submissions USING btree (id);
...
CREATE UNIQUE INDEX sample_upload_history_pkey ON sample_upload_history USING btree (upload_id);
...
CREATE UNIQUE INDEX sample_validation_issues_pkey ON sample_validation_issues USING btree (issue_id);
...
CREATE UNIQUE INDEX sample_validation_results_pkey ON sample_validation_results USING btree (validation_id);
CREATE INDEX ix_sample_validation_results_validation_id ON sample_validation_results USING btree (validation_id);
CREATE UNIQUE INDEX samples_pkey ON samples USING btree (sample_id);
CREATE INDEX ix_samples_sample_id ON samples USING btree (sample_id);
CREATE UNIQUE INDEX scoping_audit_log_pkey ON scoping_audit_log USING btree (audit_id);
CREATE INDEX ix_scoping_audit_log_audit_id ON scoping_audit_log USING btree (audit_id);
CREATE UNIQUE INDEX scoping_decision_versions_pkey ON scoping_decision_versions USING btree (decision_version_id);
CREATE UNIQUE INDEX scoping_submissions_pkey ON scoping_submissions USING btree (submission_id);
CREATE INDEX ix_scoping_submissions_submission_id ON scoping_submissions USING btree (submission_id);
CREATE UNIQUE INDEX sla_configurations_pkey ON sla_configurations USING btree (sla_config_id);
...
CREATE UNIQUE INDEX sla_escalation_rules_pkey ON sla_escalation_rules USING btree (escalation_rule_id);
CREATE INDEX ix_sla_escalation_rules_escalation_rule_id ON sla_escalation_rules USING btree (escalation_rule_id);
CREATE UNIQUE INDEX sla_violation_tracking_pkey ON sla_violation_tracking USING btree (violation_id);
CREATE INDEX ix_sla_violation_tracking_violation_id ON sla_violation_tracking USING btree (violation_id);
CREATE UNIQUE INDEX submission_documents_pkey ON submission_documents USING btree (document_id);
CREATE INDEX ix_submission_documents_document_id ON submission_documents USING btree (document_id);
CREATE UNIQUE INDEX submission_reminders_pkey ON submission_reminders USING btree (reminder_id);
CREATE INDEX ix_submission_reminders_reminder_id ON submission_reminders USING btree (reminder_id);
CREATE UNIQUE INDEX submission_validations_pkey ON submission_validations USING btree (validation_id);
CREATE INDEX ix_submission_validations_validation_id ON submission_validations USING btree (validation_id);
CREATE UNIQUE INDEX test_cases_pkey ON test_cases USING btree (test_case_id);
CREATE INDEX ix_test_cases_test_case_id ON test_cases USING btree (test_case_id);
CREATE UNIQUE INDEX test_comparisons_pkey ON test_comparisons USING btree (comparison_id);
CREATE INDEX ix_test_comparisons_comparison_id ON test_comparisons USING btree (comparison_id);
CREATE UNIQUE INDEX test_cycles_pkey ON test_cycles USING btree (cycle_id);
...
CREATE UNIQUE INDEX test_execution_audit_logs_pkey ON test_execution_audit_logs USING btree (log_id);
CREATE INDEX ix_test_execution_audit_logs_log_id ON test_execution_audit_logs USING btree (log_id);
CREATE UNIQUE INDEX test_execution_phases_pkey ON test_execution_phases USING btree (phase_id);
CREATE INDEX ix_test_execution_phases_phase_id ON test_execution_phases USING btree (phase_id);
CREATE UNIQUE INDEX test_execution_versions_pkey ON test_execution_versions USING btree (execution_version_id);
CREATE UNIQUE INDEX test_executions_pkey ON test_executions USING btree (execution_id);
CREATE INDEX ix_test_executions_execution_id ON test_executions USING btree (execution_id);
CREATE UNIQUE INDEX test_report_phases_pkey ON test_report_phases USING btree (phase_id);
CREATE UNIQUE INDEX test_report_sections_pkey ON test_report_sections USING btree (section_id);
CREATE INDEX ix_test_report_sections_section_id ON test_report_sections USING btree (section_id);
CREATE UNIQUE INDEX test_result_reviews_pkey ON test_result_reviews USING btree (review_id);
CREATE INDEX ix_test_result_reviews_review_id ON test_result_reviews USING btree (review_id);
CREATE UNIQUE INDEX tester_scoping_decisions_pkey ON tester_scoping_decisions USING btree (decision_id);
CREATE INDEX ix_tester_scoping_decisions_decision_id ON tester_scoping_decisions USING btree (decision_id);
CREATE UNIQUE INDEX testing_execution_audit_logs_pkey ON testing_execution_audit_logs USING btree (log_id);
CREATE INDEX ix_testing_execution_audit_logs_log_id ON testing_execution_audit_logs USING btree (log_id);
CREATE UNIQUE INDEX testing_execution_phases_pkey ON testing_execution_phases USING btree (phase_id);
CREATE INDEX ix_testing_execution_phases_phase_id ON testing_execution_phases USING btree (phase_id);
CREATE UNIQUE INDEX testing_test_executions_pkey ON testing_test_executions USING btree (execution_id);
CREATE INDEX ix_testing_test_executions_execution_id ON testing_test_executions USING btree (execution_id);
CREATE UNIQUE INDEX universal_assignment_history_pkey ON universal_assignment_history USING btree (history_id);
CREATE INDEX ix_universal_assignment_history_history_id ON universal_assignment_history USING btree (history_id);
CREATE UNIQUE INDEX universal_assignments_pkey ON universal_assignments USING btree (assignment_id);
...
CREATE UNIQUE INDEX user_permissions_pkey ON user_permissions USING btree (user_id, permission_id);
...
CREATE UNIQUE INDEX user_roles_pkey ON user_roles USING btree (user_id, role_id);
...
CREATE UNIQUE INDEX version_history_pkey ON version_history USING btree (id);
CREATE UNIQUE INDEX workflow_activities_pkey ON workflow_activities USING btree (activity_id);
...
CREATE UNIQUE INDEX workflow_activity_dependencies_pkey ON workflow_activity_dependencies USING btree (dependency_id);
...
CREATE UNIQUE INDEX workflow_activity_history_pkey ON workflow_activity_history USING btree (history_id);
CREATE UNIQUE INDEX workflow_activity_templates_pkey ON workflow_activity_templates USING btree (template_id);
CREATE UNIQUE INDEX uq_activity_templates_unique ON workflow_activity_templates USING btree (phase_name, activity_name);
CREATE UNIQUE INDEX workflow_alerts_pkey ON workflow_alerts USING btree (alert_id);
...
CREATE UNIQUE INDEX workflow_executions_pkey ON workflow_executions USING btree (execution_id);
...
CREATE UNIQUE INDEX workflow_metrics_pkey ON workflow_metrics USING btree (metric_id);
...
CREATE UNIQUE INDEX workflow_phases_pkey ON workflow_phases USING btree (phase_id);
CREATE INDEX ix_workflow_phases_phase_id ON workflow_phases USING btree (phase_id);
CREATE UNIQUE INDEX workflow_steps_pkey ON workflow_steps USING btree (step_id);
...
CREATE UNIQUE INDEX workflow_transitions_pkey ON workflow_transitions USING btree (transition_id);
