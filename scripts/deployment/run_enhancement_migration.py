#!/usr/bin/env python3
"""
Run the enhancement tables migration
Adds tables for data sources, profiling, and intelligent sampling
"""
import asyncio
import subprocess
import sys
...
def main():
    ...
    print("Enhancement Tables Migration Script")
    print("=" * 50)
    print("This script will add the following features:")
